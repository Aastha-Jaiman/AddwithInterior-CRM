...
import { useQuotation } from "./ModularKitchenQuotation";

const QuotationForm = () => {
  const { createQuotation, fetchClients, fetchProjectsByEmail, loading, error } = useQuotation();
  ...
  const handleClientChange = async (e) => {
    ...
    const projectsData = await fetchProjectsByEmail(email);
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <label>Project:</label>
      <select onChange={(e) => setFormData({ ...formData, project: e.target.value })} required>
      ...
      {/* Add sections input as needed */}
      
      <button type="submit" disabled={loading}>Create Quotation</button>
