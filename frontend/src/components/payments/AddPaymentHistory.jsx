...
export default function AddPaymentPage() {
  ...
  // Modified handleSubmit to send FormData including the file
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    setErr("");
    ...
    try {
      ...
      formData.append("clientId", clientDetails?._id);
      ...
      await addPayment(formData); // Ensure your addPayment service sends FormData with multipart/form-data headers
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="block w-full text-sm text-gray-500 file:py-2 file:px-4 file:border file:border-gray-300 file:rounded-md file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
            />
          </div>
        </div>
