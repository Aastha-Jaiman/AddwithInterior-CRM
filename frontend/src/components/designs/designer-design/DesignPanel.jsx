...
const sampleProjects = [
    {
        ...
        customer: { name: "Rajesh Kumar", phone: "+91 9876543210", email: "rajesh@email.com" },
    ...
    },
    {
        ...
        customer: { name: "Tech Solutions Pvt Ltd", phone: "+91 9123456789", email: "contact@techsol.com" },
        category: "Commercial",
        ...
        design: { url: "/api/placeholder/300/200", name: "office_design_v2.pdf", uploadDate: "2024-02-15" },
        designHistory: [
    ...
    },
    {
        ...
        customer: { name: "Sunita Agarwal", phone: "+91 9987654321", email: "sunita@email.com" },
        category: "Interior",
        ...
        design: { url: "/api/placeholder/300/200", name: "luxury_apt_final.pdf", uploadDate: "2024-01-20" },
        designHistory: [
...
const DesignerPanel = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            {/* Header */}
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Designer Panel</h1>
                <p className="text-gray-600">Manage your assigned projects and upload designs</p>
            </div>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {projects.map((project) => (
                                <tr key={project.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className={`px-2 py-1 text-xs font-medium rounded-full ${getDesignStatusColor(project.designStatus)}`}>
