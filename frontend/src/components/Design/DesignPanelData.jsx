...
const ProjectDetails = ({ project, onBack, onProjectUpdate }) => {
  ...
  const canUpload = useHasPermission("upload_design");
          ...
          <div className="md:flex">
            ...
            <div className="md:w-2/5 relative">
              ...
              <div className="absolute top-4 right-4">
                <span
                  className={`px-4 py-2 rounded-full text-sm font-bold ${getDesignStatusColor(
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-indigo-700">
                        Uploaded on {project.design.uploadDate}
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <button
                        onClick={() =>
                          window.open(project.design.url, "_blank")
                        }
              ...
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                ...
                <span className="font-semibold text-gray-900">
                  {project.startingDate
                    ? Math.ceil(
                        (new Date() - new Date(project.startingDate)) /
                          (1000 * 60 * 60 * 24)
                      )
                    : "N/A"}
                </span>
