...
const { createAdmin, registerStaffByAdmin, login, profiledData, updateStaffByAdmin, logout, updateAdminSelf, resetEmailToken, changePassword, resetPassword, getAllStaff, getClientById } = require('../controller/admin.controller');
...
router.get("/client/:id", adminauthMiddleware, getClientById);
