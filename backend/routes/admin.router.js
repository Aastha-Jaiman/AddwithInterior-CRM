...
const { createAdmin, registerStaffByAdmin, login, profiledData, updateStaffByAdmin, logout, updateAdminSelf, resetEmailToken, changePassword, resetPassword, getAllStaff } = require('../controller/admin.controller');
