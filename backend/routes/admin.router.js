...
const { createAdmin, registerStaffByAdmin, login, profiledData, updateStaffByAdmin, logout, updateMyProfile, resetEmailToken, changePassword, resetPassword, getAllStaff, getStaffById } = require('../controller/admin.controller');
