...
const { registerClientByAdmin, loginClient, getProfile, logoutClient, updateClientByAdmin, getAllClientByAdmin, resetPassword, resetEmailToken , changePassword, getClientById } = require('../controller/client.controller');
