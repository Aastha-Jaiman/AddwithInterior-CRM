...
const { registerClientByAdmin, loginClient, getProfile, logoutClient, updateClientByAdmin, getAllClientByAdmin, resetPassword, forgotPassword , changePassword } = require('../controller/client.controller');
